...
class Popup extends React.Component {
  ...
  state = {
    coins: [{coinName:"", coinQuantity:"", isCoinNameValid:false, isCoinQuantityValid:false, hasFormBeenSubmitted:false}],
    error: "none"
  }
  ...
  componentDidMount() {
    ...
    chrome.storage.sync.get('userSubmittedCoinData', (data) => {
      if (data.userSubmittedCoinData) {this.setState({coins: data.userSubmittedCoinData});}
    });
  ...
  isUserTypingNumbersIntoNameField = (e) => {
    if (["coinName"].includes(e.target.dataset.fieldType)) {
      ...
      if(reg.test(e.nativeEvent.data)) {
        if(e.nativeEvent.data != null) { return true; }}
    }
    return false;
  }
 ...
 // This function is entered whenever user submits the form.
  ...
  addCoin() {
    this.setState((prevState) => ({
      coins: [...prevState.coins, {coinName:"", coinQuantity:"", isCoinNameValid:false, isCoinQuantityValid:false, hasFormBeenSubmitted:false}],
    }));
  }
      ...
      <div className="popUpContainer">
        ...
        <div className="formContainer">
          ...
          <div className="submitContainer">
            <input onClick={this.handleSubmitForm} type="submit" value={submitButtonText} className={submitButtonClass}/> 
          </div>
        </div>
      </div>
    )
